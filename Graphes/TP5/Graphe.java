...
/*------------------------------ TP 4  -------------------------------------------------*/
	...
	/* J'ai creer une nouvlle classe GrapheValues qui herite de la classe Graphe
	 	...
	 	et getArete(int i, int j) qui sont des version modifier des methodes de la classe Graphe
	  	pour pouvoir prendre en compte cet enrichissement 
	*/

	/* On a besoin d'un Tableau a deux demension. La première ligne contiendra d(i) et la seonde ligne 
		contiendra le pere(i)
	*/
}
